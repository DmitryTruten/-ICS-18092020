...
test_list = [TranslationItem("Student", "Cтудент"), TranslationItem("Teacher", "Преподаватель"), TranslationItem("Conglomerate", "Конгломерат"),TranslationItem("Assets", "Активы")]
translator = Translator()

for test_item in test_list:
    translator.add_translation(test_item)

translator.print_translations_of_english_word("Student")
translator.print_translations_of_english_word("Teacher")
translator.print_translations_of_english_word("Conglomerate")
translator.print_translations_of_english_word("Assets")